...
def realizar_transacao(clientes, tipo_transacao):
    ...
    valor = float(input(f"Informe o valor da {tipo_transacao}: "))
    transacao = Saque(valor) if tipo_transacao == "saque" else Deposito(valor)
...
def criar_conta(numero_conta, clientes, contas):
    ...
    limite_saques = int(input("Informe a quantidade de saques permitidos: "))
